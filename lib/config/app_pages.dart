...
import 'package:ag_chirag_web/screens/module/Tabs/custom_widget/main_shell_screen.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(name: AppRoutes.mainShell, page: () => MainShell(),transition: Transition.fadeIn,  transitionDuration: Duration(milliseconds: 400),),
  ];
}