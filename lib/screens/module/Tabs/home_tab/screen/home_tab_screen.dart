...
class _HomeTabScreenState extends State<HomeTabScreen> {
  ...
  //         1: FlexColumnWidth(2.5), // User Name (Needs more space for longer names)
  //         2: FlexColumnWidth(1.5), // Position PNL
  //         3: FlexColumnWidth(1.5), // Balance
  //         4: FlexColumnWidth(1.2), // Status (Gives padding for the badge)
  ...
  //               .toList(),
  //         ),
  //         ...homeScreenController.usersList
  //             .asMap() // 1. Convert to map to get access to keys (indices)
  //             .entries
  //             .map(
  //               (entry) {
  //             int index = entry.key; // 2. Extract the index
  //             var u = entry.value;   // 3. Extract your user object
  //
  //             return TableRow(
  ...
  //                             clientData: u,
  //                             documentId: u.userId,
  //                             index: index, // 4. index successfully passed here!
  //                           ),
  //                         );
  //                       },
  //                     ),
  ...
  //       ],
  //     ),
  //     Obx(() => homeScreenController.isLoginApiLoading.value
  //         ? Container(
